...
# Optional tqdm integration with Loguru
try:
...
class ExecutorLogger:
    ...
    def __init__(self, logs_path: Optional[str] = None, level: str = "INFO"):
        ...
        """
        self.logger = logger
        self.logger.remove()  # Remove any default logger
...
# ───────────────────────────────────────────────────────────────────────────────
# Create a logger instance for global use
logger = ExecutorLogger("globals").logger
